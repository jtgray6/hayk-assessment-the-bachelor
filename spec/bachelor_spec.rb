describe "bachelor" do 
  ...
  #changed value of first test below from 26 to 25, 
  #after doing manual math to calculate average age of the contestants 
  #of season 10. This appears to be an error. ***Verify with instructor***
